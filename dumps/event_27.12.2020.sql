...
INSERT INTO `alembic_version` VALUES ('dfdc9c010623');
...
INSERT INTO `association` VALUES (3,1),(5,1),(5,2),(14,2),(15,2),(15,4),(5,4),(14,4),(5,5),(40,2);
...
CREATE TABLE `document` (
  ...
  PRIMARY KEY (`id`),
  KEY `users_id` (`users_id`),
  CONSTRAINT `document_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
...
INSERT INTO `document` VALUES (77,'vetz.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5),(78,'vet.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5),(79,'vesti_1.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5),(80,'medvedev.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5),(81,'dvuhg.jpg','2020-12-26 02:32:31','2020-12-27 02:05:15',40),(82,'domin.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5),(83,'domi.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5),(84,'bahmetov.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5),(85,'bahmeto.jpg','2020-12-26 02:32:31','2020-12-26 02:32:31',5);
...
INSERT INTO `roles` VALUES (1,'admin','Администратор',NULL,'2020-12-27 01:50:32','Администратор'),(2,'users','users',NULL,'2020-12-27 01:50:18','Пользователь'),(3,'edit','Edit',NULL,NULL,NULL),(4,'manager','Manager',NULL,'2020-12-27 01:35:32','Менеджер'),(5,'super_admin','Супер Администратор','2020-12-25 16:52:29','2020-12-27 00:51:52','Главный администратор');
...
CREATE TABLE `users` (
  ...
  `create_time` datetime DEFAULT NULL,
  `edit_time` datetime DEFAULT NULL,
  `lead_roles_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`),
  UNIQUE KEY `ix_users_login` (`login`),
  KEY `lead_roles_id` (`lead_roles_id`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`lead_roles_id`) REFERENCES `roles` (`id`),
...
INSERT INTO `users` VALUES (3,'admin@admin.ru','$2b$12$NM5gLgPCvn650S5f1LRToO7Zvrlk.pfzzVIUxKcbX3fjCsisDimhC',1,NULL,NULL,NULL,NULL,NULL,NULL,'admin','Admin','Admin','Admin',NULL,NULL,NULL),(5,'vestimyandrey@gmail.com','$2b$12$SV3G.U1zGVXZswyui9CnQuyFBK4jsS9hV.mO46k.gIfz82cCLpFbO',1,'Воронежская область, Новоусманский район, с. Новая Усмань, ул. Центральная д.1 кв. 1','1992-02-18','https://www.facebook.com/vestimyandrey',NULL,'89192320772','vesti_1.jpg','Vestimy','Вестимый','Андрей','Петрович',NULL,'2020-12-27 00:48:38',5),(14,'domnikov@mail.ru','$2b$12$eoLF/L89SKTTZRYp1cYuWOTQVM2OpARnHHUTNnbZ5JUWIi3Lze8XS',1,NULL,'1977-01-07',NULL,NULL,NULL,'domin.jpg','domnikov','Домников','Сергей','Михайлович',NULL,'2020-12-27 01:40:08',4),(15,'rommires@yandex.ru','$2b$12$VQqu1d1DsYFyPLZEeStmpeOy7sMkGOj0I42qsQRzv0adW4M9nTDGa',1,NULL,NULL,NULL,NULL,NULL,NULL,'medvedev','Медведев','Роман','Владимирович',NULL,'2020-12-27 00:53:55',4),(40,'dyadako@mail.ru','nikola',1,NULL,'1979-12-11',NULL,NULL,NULL,NULL,'nikola','Двухголовых','Николай','Николаевич','2020-12-27 02:03:54','2020-12-27 02:06:41',2);
...
-- Dump completed on 2020-12-27 13:23:10
