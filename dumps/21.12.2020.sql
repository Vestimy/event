...
INSERT INTO `alembic_version` VALUES ('a177129500d6');
...
INSERT INTO `association` VALUES (3,1),(5,1),(5,2),(14,2),(15,2),(15,4),(5,4),(14,4);
...
INSERT INTO `roles` VALUES (1,'admin','Администратор'),(2,'users','users'),(3,'edit','Edit'),(4,'manager','Manager');
...
INSERT INTO `typehall` VALUES (1,'Клубы',NULL),(2,'Дом культуры',NULL),(3,'уличные площадки',NULL),(4,'Цирк',NULL),(5,'Филармония',NULL),(6,'Театр',NULL),(7,'Концертный зал',NULL),(8,'Ресторан',NULL),(9,'Спортивная арена',NULL);
...
INSERT INTO `users` VALUES (3,'admin@admin.ru','$2b$12$NM5gLgPCvn650S5f1LRToO7Zvrlk.pfzzVIUxKcbX3fjCsisDimhC',1,NULL,NULL,NULL,NULL,NULL,NULL,'admin','Admin','Admin','Admin'),(5,'vestimyandrey@gmail.com','$2b$12$SV3G.U1zGVXZswyui9CnQuyFBK4jsS9hV.mO46k.gIfz82cCLpFbO',1,'Центральная 1','1992-02-18','https://www.facebook.com/vestimyandrey',NULL,'89192320772','profiles/vesti_1.jpg','Vestimy','Вестимый','Андрей','Петрович'),(14,'domnikov@mail.ru','$2b$12$eoLF/L89SKTTZRYp1cYuWOTQVM2OpARnHHUTNnbZ5JUWIi3Lze8XS',1,NULL,'1977-01-07',NULL,NULL,NULL,'profiles/domi.jpg','domnikov','Домников','Сергей','Михайлович'),(15,'rommires@yandex.ru','$2b$12$VQqu1d1DsYFyPLZEeStmpeOy7sMkGOj0I42qsQRzv0adW4M9nTDGa',1,NULL,NULL,NULL,NULL,NULL,NULL,'medvedev','Медведев','Роман','Владимирович');
...
-- Dump completed on 2020-12-21 22:50:58
